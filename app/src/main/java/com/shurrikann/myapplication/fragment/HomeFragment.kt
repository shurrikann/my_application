...
//            binding.textviewMainTitle.text = "返回结果:$data"
    ...
    override fun initView() {
        binding.compress.setContent {
            ...
            MaterialTheme {
                //获取当前屏幕方向
                PrimaryButtonList(onNavigateToPermissions = {
...
@Preview(showBackground = true, name = "主界面按钮预览")
@Composable
fun PrimaryButtonListPreview() {
    MaterialTheme {
        PrimaryButtonList(
            onShowToast = {},
